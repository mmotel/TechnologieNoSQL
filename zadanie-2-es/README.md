...
W czasie `165m45.252s` (`~2h45m`) zaimportowało `19 766 542` obiektów. Co daje średnio `~1 419` insertów na sekundę. ***Czemu (nadal) tak wolno?***
...
Cały skrypt: [tutaj](./scripts/convert-dates.js).
